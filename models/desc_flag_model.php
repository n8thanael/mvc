...
class desc_flag_Model extends model {
    ...
    public function prep_orig_db() {
        $array = array();
        //bypass:
        $array['name'] = $this->fetchrecord_raw[0]['name'];
        $array['description'] = $this->fetchrecord_raw[0]['description'];
        $array['short'] = $this->fetchrecord_raw[0]['short'];

    //TURNED OFF TO ALLOW TinyMCE to function
